...
//			.antMatchers("/**").permitAll()
			...
			.antMatchers("/Exam/**").hasAuthority("ROLE_STUDENT")
			.antMatchers("/Examhistory/**").hasAuthority("ROLE_STUDENT")
			.antMatchers("/ExamMarking/**").permitAll()
			.antMatchers("/teacher/getProductions").hasAuthority("ROLE_TEACHER")
			.antMatchers("/teacher/saveExcellentProductions").hasAuthority("ROLE_TEACHER")
			.antMatchers("/teacher/getExcellentProductions").permitAll()
			.antMatchers("/paperListAdmin/**").hasAuthority("ROLE_ADMIN")
			.antMatchers("/student/**").hasAuthority("ROLE_STUDENT")
			.antMatchers("/questionbank/**").hasAuthority("ROLE_ADMIN")
